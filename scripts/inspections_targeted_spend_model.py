"""
Targeted FIFRA-Aligned Spending Model — WPS Inspections Analysis

DV: total WPS inspections per state-year (EPA + state inspections)
Mirrors targeted_spend_model.py exactly; only the outcome differs.

Pre-specified formula retains the same predictors as the violations analysis
(based on p < .20 interaction thresholds from spending_bls_models.py):
  ...
  interactions:  SPEND_APP_z:time, SPEND_AREA_z:time

Requires spend_bls_variables.csv (generated by spending_bls_models.py).
"""
...
print("=" * 70)
print("TARGETED FIFRA-ALIGNED SPENDING MODEL — WPS INSPECTIONS ANALYSIS")
print("=" * 70)

# ============================================================
# [1] LOAD BASE INSPECTIONS AND SPENDING DATA
# ============================================================
...
print(f"\n  Formula: {formula}")
print("\n  (Interactions pre-specified from violations analysis: SPEND_APP_z and SPEND_AREA_z had p<.20)")
